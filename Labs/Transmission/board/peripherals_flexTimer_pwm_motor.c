...
/*******************************************************************************
 * flexTimer_pwm_motor initialization code
 ******************************************************************************/
/* clang-format off */
/* TEXT BELOW IS USED AS SETTING FOR TOOLS *************************************
instance:
- name: 'flexTimer_pwm_motor'
- type: 'flexTimer_pwm'
- mode: 'general'
        ...
        - FtmPwmConfigArr:
          ...
          - ftmPwmIndptChnCfg:
            - pwmIndependentChannelConfig:
              - 0:
                - ftmpwmIndptName: 'flexTimer_pwm_motor_IndependentChannelConfig0'
              ...
              - 1:
                ...
                - IndptdeadTimeEn: 'false'
              - 2:
                - ftmpwmIndptName: 'flexTimer_pwm_motor_IndependentChannelConfig2'
...
/* Global configuration of flexTimer_pwm_motor InitConfig */
ftm_user_config_t flexTimer_pwm_motor_InitConfig =
{
    {
...
ftm_pwm_fault_param_t flexTimer_pwm_motor_FaultConfig =
{
...
/* The independent channels configuration structure for flexTimer_pwm_motor_IndependentChannelsConfig */
ftm_independent_ch_param_t flexTimer_pwm_motor_IndependentChannelsConfig[3] =
{
    {
...
ftm_pwm_param_t flexTimer_pwm_motor_PwmConfig =
{
    ...
    1000U, /* PWM frequency */
    flexTimer_pwm_motor_IndependentChannelsConfig, /* The independent PWM channels configuration structure */
    NULL, /* Combined PWM channels configuration structure */
    &flexTimer_pwm_motor_FaultConfig /* PWM fault configuration structure */
};
