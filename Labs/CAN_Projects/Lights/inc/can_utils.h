...
#define LIGHTS_TX_ID        0x112
#define STEERING_TX_ID      0x113
#define COMFORT_TX_ID       0x114
#define TRANSMISSION_TX_ID  0x115

#define HMI_RX_ID           0x210
#define BRAKES_RX_ID        0x211
#define LIGHTS_RX_ID        0x212
#define STEERING_RX_ID      0x213
#define COMFORT_RX_ID       0x214
