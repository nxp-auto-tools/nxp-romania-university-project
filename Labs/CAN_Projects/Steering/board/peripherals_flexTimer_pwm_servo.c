...
/*******************************************************************************
 * flexTimer_pwm_servo initialization code
 ******************************************************************************/
/* clang-format off */
/* TEXT BELOW IS USED AS SETTING FOR TOOLS *************************************
instance:
- name: 'flexTimer_pwm_servo'
- type: 'flexTimer_pwm'
- mode: 'general'
        ...
        - FtmPwmConfigArr:
          ...
          - ftmPwmIndptChnCfg:
            - pwmIndependentChannelConfig:
              - 0:
                - ftmpwmIndptName: 'flexTimer_pwm_servo_IndependentChannelConfig0'
                - ftmPwmIndptHwChnId: '7'
                - polarity: 'FTM_POLARITY_HIGH'
                - uDutyCyclePercent: '0x20'
              ...
              - 1:
                - ftmpwmIndptName: 'flexTimer_pwm_servo_IndependentChannelConfig1'
...
/* Global configuration of flexTimer_pwm_servo InitConfig */
ftm_user_config_t flexTimer_pwm_servo_InitConfig =
{
    {
...
/* Fault configuration structure for flexTimer_pwm_servo*/
ftm_pwm_fault_param_t flexTimer_pwm_servo_FaultConfig =
{
...
/* The independent channels configuration structure for flexTimer_pwm_servo_IndependentChannelsConfig */
ftm_independent_ch_param_t flexTimer_pwm_servo_IndependentChannelsConfig[2] =
{
    {
        7, /* Hardware channel Id */
        FTM_POLARITY_HIGH, /* Polarity of the PWM signal */
        32U, /* Duty cycle percent 0-0x8000 */
...
/* PWM configuration for flexTimer_pwm_servo */
ftm_pwm_param_t flexTimer_pwm_servo_PwmConfig =
{
    ...
    50U, /* PWM frequency */
    flexTimer_pwm_servo_IndependentChannelsConfig, /* The independent PWM channels configuration structure */
    NULL, /* Combined PWM channels configuration structure */
    &flexTimer_pwm_servo_FaultConfig /* PWM fault configuration structure */
};
