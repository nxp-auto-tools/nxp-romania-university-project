...
- {id: LPUART1_CLK.outFreq, value: 48 MHz}
...
- {id: PCC.LPUART1_CLK_SEL.sel, value: SCG.FIRCDIV2_CLK}
...
- {id: RTCCLKSEL.sel, value: LPO32K_CLK}
...
clock_manager_user_config_t clockMan1_InitConfig0 = {
    ...
    .simConfig =
    {
        ...
        .lpoClockConfig =
        {
            ...
            .sourceRtcClk = SIM_RTCCLK_SEL_LPO_32K,/* 32 kHz LPO clock */
        },
        .platGateConfig =
        {
            .initialize = true, /*!< Initialize    */
